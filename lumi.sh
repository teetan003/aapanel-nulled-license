...
version=$(curl -Ss --connect-timeout 12 -m 2 https://bt.maxcdn.top/api/panel/getLatestOfficialVersion)
...
echo "Xài License Của Tố Gay Là 1 Sai Lầm Tuổi Trẻ"
echo "Cứ Xài Pro Lifetime Thoải Mái Nha Hiện Lỗi Gì Kệ Mẹ Nó"